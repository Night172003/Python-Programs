...
def random_emp_id(stringLength):
    ...
    strr=''.join(random.choice(Digits) for i in range(stringLength-2))
    return ('EMP'+strr)
...
class login_page:
    def __init__(self, top=None):
        ...
        top.resizable(0,0)
        top.title("Cashier Management System(ADMIN)")
        ...
        self.entry1.configure(font="-family {Times New Roman} -size 10")
        self.entry1.configure(relief="flat")
        self.entry1.configure(textvariable=user)

        self.entry2 = Entry(root)
        self.entry2.place(relx=0.373, rely=0.384, width=374, height=24)
        self.entry2.configure(font="-family {Times New Roman} -size 10")
        ...
        self.button1.configure(font="-family {Times New Roman} -size 20")
    ...
    def login(self, Event=None):
        ...
        if results:
            if results[0][5]=="Admin":
                ...
                messagebox.showerror("OOOPS!!!", "You are not an admin.")
...
class Admin_Page:
    def __init__(self, top=None):
        ...
        self.button1.place(relx=0.035, rely=0.050, width=76, height=23)
        self.button1.configure(relief="flat")
        self.button1.configure(overrelief="flat")
        ...
        self.button1.configure(font="-family {Times New Roman} -size 12")
        self.button1.configure(borderwidth="0")
        self.button1.configure(text="""LOGOUT""")
        self.button1.configure(command=self.Logout)

        self.button2 = Button(adm)
        self.button2.place(relx=0.260, rely=0.508, width=146, height=63)
        ...
        self.button2.configure(font="-family {Times New Roman} -size 12")
        self.button2.configure(borderwidth="0")
        self.button2.configure(text="""Inventory""")
        self.button2.configure(command=inventory)

        self.button3 = Button(adm)
        self.button3.place(relx=0.456, rely=0.508, width=146, height=63)
        ...
        self.button3.configure(font="-family {Times New Roman} -size 12")
        self.button3.configure(borderwidth="0")
        self.button3.configure(text="""Employees""")
        self.button3.configure(command=employee)

        self.button4 = Button(adm)
        self.button4.place(relx=.656, rely=0.508, width=146, height=63)
        ...
        self.button4.configure(font="-family {Times New Roman} -size 12")
...
class Inventory:
    def __init__(self, top=None):
        ...
        self.clock.place(relx=0.046, rely=0.065, width=102, height=36)
        self.clock.configure(font="-family {Times New Roman Light} -size 12")
        ...
        self.entry1.configure(font="-family {Times New Roman} -size 12")
        self.entry1.configure(relief="flat")
        ...
        self.button1.configure(font="-family {Times New Roman} -size 10")
        self.button1.configure(borderwidth="0")
        ...
        self.button3.configure(background="green")
        self.button3.configure(font="-family {Times New Roman} -size 12")
        self.button3.configure(borderwidth="0")
        ...
        self.button5.configure(font="-family {Times New Roman} -size 12")
        ...
        self.button6.configure(font="-family {Times New Roman} -size 12")
    ...
    def search_product(self):
        ...
        try:
            ...
            messagebox.showerror("OOOPS!!!", "Invalid Product Id.", parent=inv)
        else:
            for search in val:
                if search==to_search:
                ...
                messagebox.showerror("OOOPS!!!", "Product ID: {} not found.".format(self.entry1.get()), parent=inv)
    ...
    def delete_product(self):
        ...
        if len(self.sel)!=0:
            ...
            if sure == True:
                ...
                messagebox.showinfo("Success!!!", "Product(s) deleted from database.", parent=inv)
                self.sel.clear()
...
class add_product:
    def __init__(self, top=None):
        ...
        self.entry2.configure(font="-family {Times New Roman} -size 12")
        self.entry2.configure(relief="flat")
        ...
        self.entry3.configure(font="-family {Times New Roman} -size 12")
        ...
        self.button1.configure(foreground="white")
        self.button1.configure(background="green")
        self.button1.configure(font="-family {Times New Roman} -size 14")
        self.button1.configure(borderwidth="0")
        ...
        self.button2.configure(foreground="white")
        self.button2.configure(background="#CF1E14")
        self.button2.configure(font="-family {Times New Roman} -size 14")
        self.button2.configure(borderwidth="0")
                ...
                if pqty:
                    if pcp:
                        try:
                            ...
                            messagebox.showerror("OOOPS!", "Invalid cost price.", parent=p_add)
                        else:
                            if pmrp:
                                try:
                                    float(pmrp)
                                except ValueError:
                                    messagebox.showerror("OOOPS!", "Invalid MRP.", parent=p_add)
                                else:
                                    with sqlite3.connect("./Database/database.db") as db:
                                        cur = db.cursor()
                                    insert = (
                                        "INSERT INTO inventory(product_name, product_cat, stock, mrp, cost_price) VALUES(?,?,?,?,?)"
                                    )
                                    cur.execute(insert, [pname, pcat, int(pqty), float(pmrp), float(pcp)])
                                    db.commit()
                                ...
                                messagebox.showerror("OOOPS!", "Please enter MRP.", parent=p_add)
                    else:
                        messagebox.showerror("OOOPS!", "Please enter product cost price.", parent=p_add)
                else:
                    messagebox.showerror("OOOPS!", "Please enter product quantity.", parent=p_add)
            else:
                messagebox.showerror("OOOPS!", "Please enter product category.", parent=p_add)
        else:
            messagebox.showerror("OOOPS!", "Please enter product name", parent=p_add)
                ...
                if pqty:
                    if pcp:
                        try:
                            ...
                            messagebox.showerror("OOOPS!", "Invalid cost price.", parent=p_update)
                        else:
                            if pmrp:
                                try:
                                    float(pmrp)
                                except ValueError:
                                    messagebox.showerror("OOOPS!", "Invalid MRP.", parent=p_update)
                                else:
                                    product_id = valll[0]
                                    with sqlite3.connect("./Database/database.db") as db:
                                        cur = db.cursor()
                                    update = (
                                        "UPDATE inventory SET product_name = ?, product_cat = ?, stock = ?, mrp = ?, cost_price = ? WHERE product_id = ?"
                                    )
                                    cur.execute(update, [pname, pcat, int(pqty), float(pmrp), float(pcp), product_id])
                                    db.commit()
                                ...
                                messagebox.showerror("OOOPS!", "Please enter MRP.", parent=p_update)
                    else:
                        messagebox.showerror("OOOPS!", "Please enter product cost price.", parent=p_update)
                else:
                    messagebox.showerror("OOOPS!", "Please enter product quantity.", parent=p_update)
            else:
                messagebox.showerror("OOOPS!", "Please enter product category.", parent=p_update)
        else:
            messagebox.showerror("OOOPS!", "Please enter product name", parent=p_update)
...
class Employee:
    ...
    def search_emp(self):
        ...
        for search in val:
            ...
            messagebox.showerror("OOOPS!!!", "Employee ID: {} not found.".format(self.entry1.get()), parent=emp)
...
class add_employee:
    def __init__(self, top=None):
        ...
        self.entry4.configure(font="-family {Times New Roman} -size 12")
        ...
        self.entry5.configure(font="-family {Times New Roman} -size 12")
        ...
        if ename.strip():
            if valid_phone(econtact):
                    if edes:
                        if eadd:
                            if epass:
                                emp_id = random_emp_id(5)
                                insert = (
                                            "INSERT INTO employee(emp_id, name, contact_num, address, password, Role) VALUES(?,?,?,?,?,?)"
                                        )
                                ...
                                messagebox.showerror("OOOPS!", "Please enter a password.", parent=e_add)
                        else:
                            messagebox.showerror("OOOPS!", "Please enter address.", parent=e_add)
                    else:
                        messagebox.showerror("OOOPS!", "Please enter Role.", parent=e_add)
            else:
                messagebox.showerror("OOOPS!", "Invalid phone number.", parent=e_add)
        else:
            messagebox.showerror("OOOPS!", "Please enter employee name.", parent=e_add)
                ...
                if edes:
                    if eadd:
                        if epass:
                            emp_id = vall[0]
                            update = (
                                "UPDATE employee SET name = ?, contact_num = ?, password = ?, address = ?, Role = ? WHERE emp_id = ?"
                                )
                            cur.execute(update, [ename, econtact, eadd, epass, edes, emp_id])
                            db.commit()
                            ...
                            messagebox.showerror("OOOPS!", "Please enter a password.", parent=e_update)
                    else:
                        messagebox.showerror("OOOPS!", "Please enter address.", parent=e_update)
                else:
                    messagebox.showerror("OOOPS!", "Please enter Role.", parent=e_update)
            else:
                messagebox.showerror("OOOPS!", "Invalid phone number.", parent=e_update)
        else:
            messagebox.showerror("OOOPS!", "Please enter employee name.", parent=e_update)
...
class Invoice:
    def __init__(self, top=None):
        ...
        self.message.configure(font="-family {Times New Roman} -size 10")
    ...
    def search_inv(self):
        ...
        for search in val:
            ...
            messagebox.showerror("OOOPS!!!", "Bill NUmber: {} not found.".format(self.entry1.get()), parent=invoice)
...
class open_bill:
    def __init__(self, top=None):
        ...
        self.Scrolledtext1.configure(font="-family {Times New Roman} -size 8")
