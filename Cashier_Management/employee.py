...
class bill_window:
    def __init__(self, top=None):
        ...
        self.button3.configure(font="-family {Times New Roman} -size 10")
        ...
        self.button4.configure(font="-family {Times New Roman} -size 10")
        ...
        self.button5.configure(font="-family {Times New Roman} -size 10")
        ...
        self.button6.configure(font="-family {Times New Roman} -size 10")
        ...
        self.button7.configure(background="green")
        self.button7.configure(font="-family {Times New Roman} -size 10")
        ...
        self.button8.configure(font="-family {Times New Roman} -size 10")
        ...
        self.combo1.configure(font="-family {Times New Roman} -size 8")
        ...
        self.combo2.configure(font="-family {Times New Roman} -size 8")
        self.combo2.option_add("*TCombobox*Listbox.font", text_font)
        self.combo2.configure(state="disabled")

        self.entry4 = ttk.Entry(biller)
        self.entry4.place(relx=0.035, rely=0.551, width=477, height=26)
        self.entry4.configure(font="-family {Times New Roman} -size 8")
    ...
    def get_category(self, Event):
        ...
        self.combo2.set('')
        find_product = "SELECT product_name FROM inventory WHERE product_cat = ?"
        cur.execute(find_product, [self.combo1.get()])
        result2 = cur.fetchall()
        products = []
        for j in range(len(result2)):
            products.append(result2[j][0])

        self.combo2.configure(values=products)
        self.combo2.bind("<<ComboboxSelected>>", self.show_qty)
        self.show_qty()

    def show_qty(self,  Event):
        self.entry4.configure(state="normal")
        self.qty_label = Label(biller)
        self.qty_label.place(relx=0.033, rely=.600, width=82, height=26)
        self.qty_label.configure(font="-family {Times New Roman} -size 8")
        self.qty_label.configure(anchor="w")

        product_name = self.combo2.get()
    ...
    def gen_bill(self):
        ...
        if self.state == 1:
            ...
            if (cust_name.get() == ""):
                ...
                messagebox.showerror("Oops!", "Please enter a valid contact number.", parent=biller)
