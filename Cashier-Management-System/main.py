...
main.title("Cashier Management System")
main.resizable(0, 0)
...
button1.configure(activebackground="white",foreground="white",background="white",borderwidth="0")
...
button2.configure(activebackground="white",foreground="white",background="white",borderwidth="0")
